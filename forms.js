...
var formHelpers = {
	...
	submit: function(form) {
		...
		var jsonData = {};
		var allField = this.allField();
		var hasPartnerPage = document.querySelector('.become-partner');
		var endPointContact = this.url + '/mail';
		var endPointPartner = this.url + '/become-partner';
		var finalEndpoint = !!hasPartnerPage ? endPointPartner : endPointContact;
